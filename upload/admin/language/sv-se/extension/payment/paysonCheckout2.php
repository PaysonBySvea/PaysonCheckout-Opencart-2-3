...
$_['text_phone_yes'] = 'ja';
$_['text_phone_no'] = 'nej';
$_['text_request_phone_optional'] = 'Aktivera telefon tillval';
$_['entry_phone_optional'] = 'Telefon tillval';
$_['text_phone_optional_yes'] = 'ja';
$_['text_phone_optional_no'] = 'nej';
$_['text_request_registered_customer'] = 'Kan användas för att aktivera enbart registrerade kunder vid användning av modulen Ajax Quick Checkout';
$_['entry_registered_customer'] = 'Registrerade kunder';
...
$_['help_request_phone'] = 'Används för att kräva att användaren fyller i sitt telefonnummer';
$_['help_request_phone_optional'] = 'Välj telefon valfritt för att be användaren att fylla i sitt telefonnummer, men inte strikt krävs';
...
$_['help_order_status_shipped'] = 'Meddela Payson att ordern har skickats.<br />Vänligen kontrollera under Admin | System -> Tools -> Error Logs att ordern har fått status skickad i Payson innan den skickas till kunden.';
$_['help_order_status_canceled'] = 'Meddela Payson att ordern har avbrutits.<br />Vänligen kontrollera under Admin | System -> Tools -> Error Logs att ordern har fått status cancelled  i Payson.';
$_['help_order_status_refunded'] = 'Meddela Payson att ordern ska krediteras.<br />Vänligen kontrollera under Admin | System -> Tools -> Error Logs att ordern har fått status paidToAccount/Krediterad  i Payson.';
?>